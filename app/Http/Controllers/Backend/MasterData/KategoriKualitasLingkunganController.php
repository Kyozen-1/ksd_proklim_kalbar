...
class KategoriKualitasLingkunganController extends Controller
{
    /**
    ...
    {
        return view('backend.master-data.kategori-kualitas-lingkungan.index');
    }

    public function datatable()
    {
        $getData = new MdKategoriKualitasLingkungan;
    ...
    public function store(Request $request)
    {
        ...
        try {
            $kategoriKategoriKualitasLingkungan = new MdKategoriKualitasLingkungan;
            $kategoriKategoriKualitasLingkungan->user_id = Auth::user()->id;
            $kategoriKategoriKualitasLingkungan->nama = $request->nama;
            $kategoriKategoriKualitasLingkungan->status_aktif = '1';
            $kategoriKategoriKualitasLingkungan->save();
    ...
    public function show(string $id)
    {
        ...
        $getData = MdKategoriKualitasLingkungan::find($id);
        $dataSend = [
            'nama' => $getData->nama
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $kategoriKategoriKualitasLingkungan = MdKategoriKualitasLingkungan::find($id);
            $kategoriKategoriKualitasLingkungan->nama = $request->nama;
            $kategoriKategoriKualitasLingkungan->save();
    ...
    public function destroy(string $id)
    {
        try {
            $id = Crypt::decryptString($id);
            $kategoriKategoriKualitasLingkungan = MdKategoriKualitasLingkungan::find($id);
            $kategoriKategoriKualitasLingkungan->status_aktif = '0';
            $kategoriKategoriKualitasLingkungan->save();
