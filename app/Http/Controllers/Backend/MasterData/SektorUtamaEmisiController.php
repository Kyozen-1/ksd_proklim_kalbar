...
class SektorUtamaEmisiController extends Controller
{
    /**
    ...
    {
        return view('backend.master-data.sektor-utama-emisi.index');
    }

    public function datatable()
    {
        $getData = new MdSektorUtamaEmisi;
    ...
    public function store(Request $request)
    {
        ...
        try {
            $sektorUtamaEmisi = new MdSektorUtamaEmisi;
            $sektorUtamaEmisi->user_id = Auth::user()->id;
            $sektorUtamaEmisi->nama = $request->nama;
            $sektorUtamaEmisi->status_aktif = '1';
            $sektorUtamaEmisi->save();
    ...
    public function show(string $id)
    {
        ...
        $getData = MdSektorUtamaEmisi::find($id);
        $dataSend = [
            'nama' => $getData->nama
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $sektorUtamaEmisi = MdSektorUtamaEmisi::find($id);
            $sektorUtamaEmisi->nama = $request->nama;
            $sektorUtamaEmisi->save();
    ...
    public function destroy(string $id)
    {
        try {
            $id = Crypt::decryptString($id);
            $sektorUtamaEmisi = MdSektorUtamaEmisi::find($id);
            $sektorUtamaEmisi->status_aktif = '0';
            $sektorUtamaEmisi->save();
