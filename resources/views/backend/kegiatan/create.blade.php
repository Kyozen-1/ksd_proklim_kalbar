...
@section('title', 'Create | Kegiatan | PROKLIM Kalimantan Barat')
@section('header', 'Create | Kegiatan')
...
@section('content')
    <form class="form-horizontal" id="form_dokumen_galeri" method="POST" action="{{ route('cms.kegiatan.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal') }}" parsley-trigger="change" required class="form-control">
                                @error('tanggal')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="link_yt" id="link_yt" value="{{ old('link_yt') }}" placeholder="Masukan Link Youtube..." class="form-control">
                                @error('link_yt')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat" id="tempat" value="{{ old('tempat') }}" parsley-trigger="change" required class="form-control" placeholder="Masukan Tempat...">
                                @error('tempat')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="alamat" id="alamat" rows="8" required>{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
