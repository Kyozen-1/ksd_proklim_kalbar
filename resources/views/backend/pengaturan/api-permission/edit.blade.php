...
@section('title', 'Edit | API Permission | Pengaturan | REDD++ Kalimantan Barat')
@section('header', 'Edit | API Permission | Pengaturan')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form
                    action="{{ route('cms.pengaturan.api-permission.update', ['id'=> $idApiPermissionEncrypted]) }}"
                    method="POST"
                    >
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $permission->name) }}" maxlength="100" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        <label for="method_display"> HTTP Method </label>
                        <input type="text" id="method_display" class="form-control" value="{{ $permission->method }}" readonly>
                    </div>

                    <div class="form-group">
                        <label for="description"> Description </label>
                        <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $permission->description) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-6 text-left">
                            <a href="{{ route('cms.pengaturan.api-permission.index') }}" class="btn btn-secondary"> <i class="fas fa-arrow-left"></i> Kembali </a>
                        </div>
