...
@section('title', 'Dokumen | PROKLIM Kalimantan Barat')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                <table id="table_dokumen" class="table table-bordered table-bordered dt-responsive nowrap">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="10%">Aksi</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" id="form_dokumen" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                        @csrf
...
@section('js')
    ...
    <script>
        $('.dropify').dropify();
        var dataTables = $('#table_dokumen').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('cms.dokumen.datatable') }}",
            },
            columns:[
                {
                    data: 'DT_RowIndex'
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            var url = "{{ route('cms.dokumen.edit', ['id' => ":id"]) }}";
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $("[name='kategori']").val(data.result.kategori).trigger('change');
        ...
        $(document).on('click', '.delete',function(){
            var id = $(this).attr('id');
            var url = "{{ route('cms.dokumen.destroy', ['id' => ":id"]) }}";
            url = url.replace(":id", id);
            return new swal({
