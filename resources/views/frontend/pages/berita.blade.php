            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                @foreach($beritas as $berita)
                    @php
                        ...
                        $summary = \Illuminate\Support\Str::limit(strip_tags($berita->deskripsi), 150);
                        $searchText = \Illuminate\Support\Str::lower($berita->judul.' '.$summary);
                    @endphp
                            ...
                            <div class="space-y-2.5">
                                <div class="flex items-center gap-4 text-[11px] sm:text-xs text-slate-400 font-semibold">
                                    <span class="inline-flex items-center gap-1">
                                        <i class="fa-regular fa-calendar text-[#00A86B]"></i>
